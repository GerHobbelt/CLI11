...
static std::pair<std::string, std::size_t> findClosestMatch(const std::string &input,
...
static void addSubcommandCloseMatchDetection(CLI::App *app, std::size_t minDistance = 3) {
...
#define main cli11_close_match_example_main
#endif
